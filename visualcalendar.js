Number.prototype.toStringN=function(num){let str = this.toString();let diff=num-Math.floor(this).toString().length;for(let i=0 ; i<diff ; i++){str='0'+str;}return str;}
...
class VisualCalendar{
  ...
  addPlanif(elem, datetime, className, title, desc){
